...
| **Purga del soft-delete** | Las filas borradas se conservan indefinidamente (volumen irrelevante hoy). | Si algún día estorban: `DELETE ... WHERE deleted_at < now() - interval '90 days'` en un cron. |
